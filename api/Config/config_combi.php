...
$config['system']['filemanagement']['root'] = $config['system']['resources']['path'] . '/' . $config['system']['filemanagement']['dirname'];
$config['system']['jobattachment']['root']  = $config['system']['resources']['path'] . '/' . $config['system']['jobattachment']['dirname'];