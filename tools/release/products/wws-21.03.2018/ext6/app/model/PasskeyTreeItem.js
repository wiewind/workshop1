 ...
 */
Ext.define('WWS.model.PasskeyTreeItem', {
    ...
    fields: [
        {
            name: 'id',
            mapping: 'PasskeyGroup.id',
            convert: function (value, record) {
                var v = record.get('PasskeyData.id');
                return (Number(v) > 0) ? Cake.prefix['tree'] + Cake.prefix['key'] + v : Cake.prefix['tree'] + Cake.prefix['group'] + record.get('PasskeyGroup.id');
            }
        },
        {
            name: 'isPasskey',
